...
* [1.27.0](https://hub.docker.com/r/11notes/go/tags?name=1.27.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/go:1.27.0
docker pull ghcr.io/11notes/go:1.27.0
docker pull quay.io/11notes/go:1.27.0
```
...
*created 20.08.2026, 06:02:41 (CET)*